    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-2">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="m-0 font-weight-bold text-primary" id="title">ATUALIZAR DADOS DO ADMINISTRADOR</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form class="user" action="editar_admin_envia.php" method="post">
